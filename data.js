  ...
  teams: [
    {
      ...
      overall: 74,
      status: "算出済",
      metrics: { retention: 81, admission: 63, event: 63, growth: 88, family: 68 },
      benchmark: {
        retention12mRate: 82.4,
        retention12mSample: 493,
        admissionRate: 34.9,
        admissionPreviousRate: 82.7,
        admissionYoYDelta: -47.8,
        eventRate: 17.2,
        repeatRate: 38.6,
      },
    },
    {
      ...
      overall: 66,
      status: "算出済",
      metrics: { retention: 48, admission: 88, event: 83, growth: 63, family: 63 },
      benchmark: {
        retention12mRate: 79.3,
        retention12mSample: 387,
        admissionRate: 69.2,
        admissionPreviousRate: 80.6,
        admissionYoYDelta: -11.5,
        eventRate: 19.7,
        repeatRate: 39.8,
      },
    },
    {
      ...
      overall: 25,
      status: "算出済",
      metrics: { retention: 17, admission: 13, event: 37, growth: 38, family: 29 },
      benchmark: {
        retention12mRate: 69.4,
        retention12mSample: 271,
        admissionRate: 18.9,
        admissionPreviousRate: 59.5,
        admissionYoYDelta: -40.6,
        eventRate: 9.5,
        repeatRate: 38.5,
      },
    },
    {
      ...
      overall: 30,
      status: "参考値を含む",
      metrics: { retention: 33, admission: 38, event: 26, growth: 13, family: 38 },
      benchmark: {
        retention12mRate: 77.8,
        retention12mSample: 144,
        admissionRate: 21.1,
        admissionPreviousRate: 63.6,
        admissionYoYDelta: -42.6,
        eventRate: 10.4,
        repeatRate: 23.6,
      },
